...
public class CarrosDB extends SQLiteOpenHelper {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        //Caso mude a versão de banco de dados o SQL de atualização deve
        //ser executado aqui.
    }
    ...
    public long save(Carro carro) {
        ...
        try {
            ...
            if (id != 0) {
                ...
                // UPDATE carro SET nome, marca WHERE _id = 1;
                int count = db.update("carro", values, "_id=?", whereArgs);
                return count;
            } else {
                //insert into carro values (...)
                // INSERT INTO carro (nome, marca) VALUES ('novocarro', 'novamarca');
